...
# Load full COCO-pretrained Mask Scoring R-CNN (caffe R50 backbone).
# Layers whose shapes differ (bbox_head/mask_head/mask_iou_head num_classes
# 80→1) are automatically skipped and re-initialised.
# === load_from disabled (pretrained COCO checkpoint unavailable) ===
load_from = None
# Original: load_from = ('https://download.openmmlab.com/mmdetection/v2.0/ms_rcnn/'
