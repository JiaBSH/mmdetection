_base_ = '../frame338_relation_v2_20260802/point-rend_r50_relation_aug_v2.py'
...
load_from = ('/data/home/scvi576/run/JiaBSH/mmdetection_para/frame338_g5090_20260801/'
             'work_dirs/point-rend_r50-caffe_fpn_custom_coco_instance/'
             'best_coco_segm_mAP_epoch_5.pth')
