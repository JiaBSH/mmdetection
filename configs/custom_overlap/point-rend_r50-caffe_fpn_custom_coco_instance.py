# PointRend for dense overlapping instance segmentation.
#
# PointRend refines masks at uncertain boundary points, which helps
# resolve ambiguous boundaries between overlapping instances.
#
# Overlap changes vs configs/custom/:
#   - RPN: nms_pre=4000, max_per_img=3000
#   - RCNN: SoftNMS, score_thr=0.001, max_per_img=300
#   - Train assigner: lower pos_iou_thr
_base_ = '../../configs/point_rend/point-rend_r50-caffe_fpn_ms-1x_coco.py'
