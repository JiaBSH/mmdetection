# SOLOv2 for dense overlapping instance segmentation.
#
# SOLOv2 improves on SOLO with dynamic convolution kernel learning
# and Matrix NMS. We lower score thresholds and increase max_per_img
# to retain more overlapping instances.
#
# Overlap changes vs configs/custom/:
#   - test_cfg: score_thr=0.01, mask_thr=0.3, max_per_img=500
#   - Matrix NMS with softer kernel sigma=2.0
_base_ = '../../configs/solov2/solov2_r50_fpn_1x_coco.py'
